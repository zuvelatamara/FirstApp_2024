...
import com.example.firstapp.Models.Cart;
import com.example.firstapp.ViewHolder.CartViewHolder;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        NextProcessBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                ...
                Intent intent = new Intent(CartActivity.this, MainActivity.class); // cREATE ConfirmFinalOrderActivity
